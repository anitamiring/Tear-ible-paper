...
namespace Sirenix.OdinInspector.Editor.Drawers
{
        ...
        where T : UnityEngine.Component
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            bool brokenInterface = this.ValueEntry.BaseValueType.IsInterface
                && !object.ReferenceEquals(this.ValueEntry.Values[0], null)
                && this.ValueEntry.Values == null;

            if (!this.isBroken && !this.ValueEntry.BaseValueType.IsInterface)
            {
                this.CallNextDrawer(label);
                return;
            }
